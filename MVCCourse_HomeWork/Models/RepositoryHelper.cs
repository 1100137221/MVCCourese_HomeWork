namespace MVCCourse_HomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerListRepository Getvw_CustomerListRepository()
		{
			var repository = new vw_CustomerListRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerListRepository Getvw_CustomerListRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerListRepository();
